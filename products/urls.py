...
from products.views import (index_view, categories_list_view,
                             product_view, ParrentCategoryCreate, ParrentCategoryUpdate)
...
urlpatterns = [
    ...
    path('product/<int:pk>/change',ParrentCategoryUpdate.as_view(),name = 'change'),
    path('product/create',ParrentCategoryCreate.as_view(),name = 'create')
