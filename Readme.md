...
для образовательных целей для демонстрации моих навыков 
в проекте присутсвует фронтенд часть но без особого углубления минимальный фронт основной упор на бекед часть . 
в данный момент проект не запущен но сервере в будещем планируется постановка на сервер
